...
const Admin = () => {
    ...
    return ( <
        ...
        id = "deleteACodeText" > Delete a Code < /p>
        ...
        onClick = { handleRemoveCodeClick }
        id = "submitRemoveCodeButton" > Delete < /button> <
        br / >
        <
        br / >
        ...
        id = "deleteButton"
        className = "hidden" > Truncate Database < /button> <
        br / >
        <
        br / >
